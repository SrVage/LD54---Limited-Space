...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	int GetRigRootBoneIndex(Avatar a, List<InternalSkeletonBone> rigBones)
	{
		if (a == null)
			return 0;

		var rv = rigBones.FindIndex(x => x.name == a.GetRootMotionNodeName());
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	RTP.RigDefinition CreateRigDefinitionFromRigAuthoring(Entity rigEntity, RigDefinitionAuthoring rigDef, Animator animator)
	{
		...
		rv.rootBoneIndex = GetRigRootBoneIndex(avatar, skeletonBones);
